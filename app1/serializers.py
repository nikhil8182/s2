...
class SensorSerializers(serializers.Serializer):
  ...
  #  Todays_Bill = serializers.FloatField(required=False)
    ...
    def update(self, instance, validated_data):
        ...
        instance.Motion_sensor = validated_data.get('Motion_sensor', instance.Motion_sensor)
        instance.Motion_sensor_2 = validated_data.get('Motion_sensor_2', instance.Motion_sensor_2)
...
class Serial(serializers.Serializer):    
    ...
    def update(self, instance, validated_data):
        ...
        instance.Device_Name = validated_data.get('Device_Name', instance.Device_Name)
        instance.Device_State  = validated_data.get('Device_State', instance.Device_State )
        instance.save()
        return instance
...
class UserSerializers(serializers.Serializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.is_Connected_to_Local_Server   = validated_data.get('is_Connected_to_Local_Server',  instance.is_Connected_to_Local_Server)
        # instance.Tab_Brightness = validated_data.get('Tab_Brightness', instance.Tab_Brightness)
        instance.save()
        return instance
...
class HeaterSerializers(serializers.Serializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.Heater_Status  = validated_data.get('Heater_Status', instance.Heater_Status )
        instance.Device_Type  = validated_data.get('Device_Type', instance.Device_Type )
